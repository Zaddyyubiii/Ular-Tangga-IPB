...
namespace Player
{
    public class PlayerEvolutionController : MonoBehaviour
    {
        ...
        public string GetStageLabel(int stage)
        {
            switch (stage)
            {
                case 1: return "🎸 Punk Bermasalah";
                case 2: return "🧢 Mahasiswa Belajar";
                case 3: return "🎒 Mahasiswa Tertib";
                case 4: return "👔 Mahasiswa Teladan";
                case 5: return "👑 Duta IPB University";
